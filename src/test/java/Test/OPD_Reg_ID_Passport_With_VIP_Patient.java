...
import Pages.Login;
import Pages.OPD_Reg_With_Passport_ID_With_VIP_Patient;
...
{
	OPD_Reg_With_Passport_ID_With_VIP_Patient registration=new OPD_Reg_With_Passport_ID_With_VIP_Patient (driver);
