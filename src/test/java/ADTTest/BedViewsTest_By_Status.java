...
import ADTPages.ADTBedViewsBY_Status;
import Pages.Login;
...
public class BedViewsTest_By_Status 
{
	...
	{
		ADTBedViewsBY_Status ADTBedView=new ADTBedViewsBY_Status(driver);
	...
	public void FailedScreenShot(ITestResult Result) throws IOException
	{
		if(ITestResult.FAILURE==Result.getStatus())
		{
			...
			FileUtils.copyFile(screenshot1, new File(".//ScreenShotFailedTestCase//Failure_BedViewsTest_By_Status.png"+ dateFormat.format(date)));
		}
	}
	@AfterSuite
