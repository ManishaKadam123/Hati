...
import ADTPages.ADTAdmissionForm_OPTOIP_NO_Convert_Charges;
import Pages.Login;
...
public class ADTAdmissionForm_OP_TO_IP_No_Convert_Charges
{
	...
	{
		ADTAdmissionForm_OPTOIP_NO_Convert_Charges ADT=new ADTAdmissionForm_OPTOIP_NO_Convert_Charges(driver);
