...
import ADTPages.BedMaster;
import ADTPages.NewBornAdmission;
import Pages.Login;
...
public class NewBornTest 
{
	...
	{
		BedMaster BedMasterConfi=new BedMaster(driver);
	...
	{
		NewBornAdmission newBorn=new NewBornAdmission (driver);
