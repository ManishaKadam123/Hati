...
import ADTPages.ADTRequestForm_For_Registred_with_Passport;
import Pages.Login;
...
public class ADT_Admission_Request_For_Registered_With_Passort 
{
	...
	{
		ADTRequestForm_For_Registred_with_Passport ADT=new ADTRequestForm_For_Registred_with_Passport(driver);
		ADT.ADT_Request_Registered_With_Passport(MRNPar,EmailPar,DOAPar,LengthPar,NotesPar,RemarksPar);
	}
	@Test(priority=3)
