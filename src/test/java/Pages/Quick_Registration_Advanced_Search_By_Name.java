...
public class Quick_Registration_Advanced_Search_By_Name 
{
	WebDriver driver=null; 
	public Quick_Registration_Advanced_Search_By_Name(WebDriver driver) 
	{
		this.driver=driver;
	...
	//MRN Field
	By NameFieldClick=By.cssSelector("input[ng-reflect-name='patientName']");
	//search Button
	...
	public void Quick_Registration_Advanced_Search_Name(String NamePAr) throws InterruptedException, IOException 
	{
		...
		Thread.sleep(2000);
		driver.findElement(NameFieldClick).sendKeys(NamePAr);
