...
import BillingPages.ADTRequestedForm_IP_Bill_Full_Settlement_Cash_Apply_GroupDiscount;
import Pages.Login;
...
public class ADTRequest_AdmissionForm_saveAdmission_IPBill_AddCharges_ApplyGroupDiscount_FullSettlement 
{
	...
	{
		ADTRequestedForm_IP_Bill_Full_Settlement_Cash_Apply_GroupDiscount ip=new ADTRequestedForm_IP_Bill_Full_Settlement_Cash_Apply_GroupDiscount(driver);
