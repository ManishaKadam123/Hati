...
import BillingPages.ADTRequestedForm_IP_Bill_Full_Settlement_Partial_Settlement;
import Pages.Login;
...
public class ADTRequest_AdmissionForm_saveAdmission_IPBill_PartialSettlement 
{
	...
	{
		ADTRequestedForm_IP_Bill_Full_Settlement_Partial_Settlement  ip=new ADTRequestedForm_IP_Bill_Full_Settlement_Partial_Settlement(driver);
