...
public class OPD_Reg_Encounter_ADT_OP_TO_IP_Deposit_Add_Against_Patient 
{
	...
	{
		ADT_AdmissionForm_save_Admission_Deposit_Add_against_patient_Save IPchargeScreen=new ADT_AdmissionForm_save_Admission_Deposit_Add_against_patient_Save(driver);
