...
import BillingPages.ADTRequestedForm_IPcharge_SaveCharges_IP_Bill_Full_Settlement_Outstanding;
import BillingPages.ADT_REQ_IP_Bill_Full_Settlement_Outstanding_Billing_Summary_Invoice_Cancel_Invoice;
import Pages.Login;
...
public class ADT_REQ_IP_Bill_Full_Settlement_Outstanding_Billing_Summary_Invoice_Cancel_Invoice_Test 
{
	...
	{
		ADT_REQ_IP_Bill_Full_Settlement_Outstanding_Billing_Summary_Invoice_Cancel_Invoice ip=new ADT_REQ_IP_Bill_Full_Settlement_Outstanding_Billing_Summary_Invoice_Cancel_Invoice(driver);
