...
public class ADTRequestedForm_IPcharge_SaveCharges_IP_Bill_Full_Settlement_Outstanding 
{
	...
	By MRNDAS=By.xpath("/html/body/app-root/app-layout/ng-sidebar-container/div/div/mat-drawer-container/mat-drawer-content/div/div/app-admission-dashboard/mat-drawer-container/mat-drawer-content/div/table/tbody/tr[1]/td[2]");
	//service Type
	...
	public void IPCharges_IPD_BIll_Outstanding() throws InterruptedException, IOException
	{
		...
		Thread.sleep(9000);
		WebElement MRN1=driver.findElement(MRNDAS);
