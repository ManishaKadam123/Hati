...
public class ADTRequestForm_For_Registred_with_Passport 
{
	...
	public void ADT_Request_Registered_With_Passport(String MRNPar,String EmailPar, String DOAPar, String LengthPar, String NotesPar, String RemarksPar) throws InterruptedException, IOException
	{
		...
		FileUtils.copyFile(screenshot2,new File(".//ScreenShot//AdmissionRequestpage_opened.png"));
	...
	public ADTRequestForm_For_Registred_with_Passport (WebDriver driver)
